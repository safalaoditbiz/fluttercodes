...
void requestContactsPermission() async {
  ...
  if (status.isDenied) {
    ...
    // Handle permanently denied permission (e.g., show a message to enable in settings)
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        accentColor: Color.fromARGB(255, 223, 226,
            224), // WhatsApp green color for floating action button
      ),
      home: HomeScreen(),
    );
  }
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                onTap: () {
                  // Handle the tap on the contact here
                  // (e.g., start a chat with the selected contact).
